...
if not exist "C:\xampp\htdocs\Library-Facilities-Booking-System\api" (
    mkdir "C:\xampp\htdocs\Library-Facilities-Booking-System\api"
    echo Created directory: C:\xampp\htdocs\Library-Facilities-Booking-System\api
) else (
    echo Directory already exists: C:\xampp\htdocs\Library-Facilities-Booking-System\api
)

REM Create the logs directory  
if not exist "C:\xampp\htdocs\Library-Facilities-Booking-System\logs" (
    mkdir "C:\xampp\htdocs\Library-Facilities-Booking-System\logs"
    echo Created directory: C:\xampp\htdocs\Library-Facilities-Booking-System\logs
) else (
    echo Directory already exists: C:\xampp\htdocs\Library-Facilities-Booking-System\logs
)

REM Create the notify.php file
(
echo ^<?php
...
echo.
echo File created: C:\xampp\htdocs\Library-Facilities-Booking-System\api\notify.php

REM Check file size
for %%A in ("C:\xampp\htdocs\Library-Facilities-Booking-System\api\notify.php") do (
