...
if (!$booking) {
    ...
    header('Location: ' . BASE_URL . '/student/my_bookings.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cancel'])) {
    ...
    header('Location: ' . BASE_URL . '/student/view_booking.php?id=' . $id);
    exit;
}
...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <a href="<?= BASE_URL ?>/student/my_bookings.php" class="btn btn-outline-secondary btn-sm">← Back</a>
</div>
    ...
    <div class="card">
      ...
      <div class="card-body p-0">
        ...
        <table class="table table-borderless mb-0">
          ...
          <tr><th class="ps-3">Attendees</th><td><?= $booking['attendees_count'] ?> / <?= $booking['capacity'] ?> capacity</td></tr>
